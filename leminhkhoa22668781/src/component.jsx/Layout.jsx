...
const Layout = () => {
  return (
    <div className="flex flex-col  font-sans">
      ...
      {/* Main content */}
      <main className="flex flex-1 bg-gray-100 justify-center py-4 h-screen flex">
        
      <div className="flex flex-col w-11/12 max-w-7xl bg-white rounded-lg shadow-lg h-[70vh] overflow-y-auto border">
         <Menu />
         <img src= {baner} alt="" />
